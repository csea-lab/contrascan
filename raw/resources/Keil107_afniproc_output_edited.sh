...
echo "auto-generated by afni_proc.py, Thu Nov  5 16:04:24 2020"
echo "(version 6.02, December 12, 2017)"
echo "execution started: `date`"

# execute via :
#   tcsh -xef proc.Keil_107 |& tee output.proc.Keil_107
...
cp Keil_107.onsetsmin2.txt $output_dir/stimuli

# copy anatomy to results dir
3dcopy Keil_107_sT1W_3D_FFE_SAG_2_1.nii \
    $output_dir/Keil_107_sT1W_3D_FFE_SAG_2_1

# ============================ auto block: tcat ============================
# apply 3dTcat to copy input dsets to results dir, while
# removing the first 1 TRs
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    Keil_107_EPI_2s_Gain_3_1.nii'[1..$]'
...
#     Keil_107_sT1W_3D_FFE_SAG_2_1_ns+orig)
align_epi_anat.py -anat2epi -anat Keil_107_sT1W_3D_FFE_SAG_2_1+orig \
...
auto_warp.py -base TT_N27+tlrc -input Keil_107_sT1W_3D_FFE_SAG_2_1_ns+orig \
...
3dbucket -prefix Keil_107_sT1W_3D_FFE_SAG_2_1_ns                           \
    awpy/Keil_107_sT1W_3D_FFE_SAG_2_1_ns.aw.nii*
...
if ( ! -f Keil_107_sT1W_3D_FFE_SAG_2_1_ns+tlrc.HEAD ) then
    echo "** missing +tlrc warp dataset:                                      \
        Keil_107_sT1W_3D_FFE_SAG_2_1_ns+tlrc.HEAD"
    exit
endif
...
foreach run ( $runs )
    ...
    cat_matvec -ONELINE                                                       \
               anat.un.aff.Xat.1D                                             \
               Keil_107_sT1W_3D_FFE_SAG_2_1_al_junk_mat.aff12.1D -I           \
               mat.r$run.vr.aff12.1D > mat.r$run.warp.aff12.1D

    # apply catenated xform: volreg/epi2anat/tlrc
    # then apply non-linear standard-space warp
    3dNwarpApply -master Keil_107_sT1W_3D_FFE_SAG_2_1_ns+tlrc -dxyz 2         \
...
3dcopy Keil_107_sT1W_3D_FFE_SAG_2_1_ns+tlrc anat_final.$subj
...
3dNwarpApply -source Keil_107_sT1W_3D_FFE_SAG_2_1+orig                        \
...
3dresample -master full_mask.$subj+tlrc -input                        \
           Keil_107_sT1W_3D_FFE_SAG_2_1_ns+tlrc                       \
...
3dresample -master full_mask.$subj+tlrc -prefix ./rm.resam.group      \
           -input /Users/andreaskeil/abin/TT_N27+tlrc
...
3dDeconvolve -input pb04.$subj.r*.scale+tlrc.HEAD                        \
    ...
    -polort A                                                     \
    -num_stimts 7                                                        \
    -stim_times 1 stimuli/Keil_107.onsetsmin2.txt 'CSPLINzero(0,18,10)'   \
    -stim_label 1 stim                                                   \
    -stim_file 2 mot_demean.r01.1D'[0]' -stim_base 2 -stim_label 2 roll  \
    -stim_file 3 mot_demean.r01.1D'[1]' -stim_base 3 -stim_label 3 pitch \
    -stim_file 4 mot_demean.r01.1D'[2]' -stim_base 4 -stim_label 4 yaw   \
    -stim_file 5 mot_demean.r01.1D'[3]' -stim_base 5 -stim_label 5 dS    \
    -stim_file 6 mot_demean.r01.1D'[4]' -stim_base 6 -stim_label 6 dL    \
    -stim_file 7 mot_demean.r01.1D'[5]' -stim_base 7 -stim_label 7 dP    \
    -jobs 2                                                              \
    -fout -tout -x1D X.xmat.1D -xjpeg X.jpg                              \
    -x1D_uncensored X.nocensor.xmat.1D                                   \
    -errts errts.${subj}                                                 \
    -iresp 1 iresp_stim.$subj                                            \
    -bucket stats.$subj
...
#
# afni_proc.py -subj_id Keil_107 -dsets Keil_107_EPI_2s_Gain_3_1.nii          \
#     -copy_anat Keil_107_sT1W_3D_FFE_SAG_2_1.nii -blocks tshift align tlrc   \
#     volreg blur mask scale regress -tcat_remove_first_trs 1 -align_opts_aea \
#     -cost lpc+ZZ -giant_move -check_flip -tlrc_base TT_N27+tlrc             \
#     -tlrc_NL_warp -volreg_align_to MIN_OUTLIER -volreg_align_e2a            \
#     -volreg_tlrc_warp -blur_size 4.0 -regress_stim_times                    \
#     Keil_107.onsetsmin2.txt -regress_stim_labels stim -regress_basis        \
#     'CSPLINzero(0,14,8)' -regress_opts_3dD -jobs 2 -regress_motion_per_run  \
